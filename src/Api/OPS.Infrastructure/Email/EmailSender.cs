            ...
            .Body($"""
                     <body style='font-family: Inter, Arial, sans-serif;'>
                       <div style='max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 5px;'>
                         ...
                         <p>Please <a href='https://truetest.tech/signin'>register</a> your account to gain admin access.</p>
            ...
            .Body($"""
                     <body style='font-family: Inter, Arial, sans-serif;'>
                       <div style='max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 5px;'>
                         ...
                         <p>Please <a href='https://truetest.tech/signin'>log in</a> to your account and start managing the platform!</p>
            ...
            .Body($"""
                   <body style='font-family: Inter, Arial, sans-serif;'>
                     <div style='max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 5px;'>
                       ...
                       <p>Please <a href='https://truetest.tech/signin'>log in</a> to your account to access the exam when it becomes available.</p>
                       <p>If you do not yet have an account, you can create one <a href='https://truetest.tech/signup'>here</a>.</p>
