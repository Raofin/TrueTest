...
const menuItems = [
  { key: 'dashboard', icon: 'lucide:layout-dashboard', label: 'Dashboard', path: '/admin/overview' },
  { key: 'viewexams', icon: 'lucide:book-open', label: 'View Exams', path: '/admin/view-exams' },
  { key: 'createexams', icon: 'lucide:plus-circle', label: 'Create Exams', path: '/admin/exams/create' },
  { key: 'invitecandidates', icon: 'lucide:users', label: 'Invite Candidates', path: '/admin/invite-candidates' },
  { key: 'users', icon: 'lucide:user', label: 'Users Management', path: '/admin/manage-users' },
  { key: 'admins', icon: 'lucide:settings', label: 'Admin Management', path: '/admin/add-admins' },
]
