...
export default function App() {
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <ol className="list-decimal list-inside space-y-2 text-sm">
                  ...
                  <li>A stable internet connection is required. If you are disconnected for more than 2 minutes, your answers will be automatically submitted.</li>
                  <li>Your face must be clearly visible in the webcam at all times, and your eyes should remain on the screen. Please do not look away from the screen.</li>
  ...
  return (
    <div className="">
      {examStarted && (
        <div className="pt-14 border-b border-white/10 p-4 z-50 shadow">
              ...
              <div key={question.id} className="space-y-4">
                ...
                {question.questionTypeId === 2 && (
                  <div className="space-y-4">
                    <p>{question.description}</p>
                    <textarea
                      className={`w-full border border-white/10 rounded-lg p-3 ${Mode==='dark'?"bg-[#27272a]":"bg-white"}`}
