        ...
        <>
            <div className="flex justify-center items-center w-full gap-10 h-screen text-xl">
                <div className={"flex flex-col gap-5 ml-7"}>
                    ...
                    <p className={"text-white text-sm border-4 border-double rounded-r-full bg-blue-800 p-3"}>A digital method of monitoring exams that ensures test integrity and
