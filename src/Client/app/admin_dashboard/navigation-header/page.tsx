  ...
  return (
    <Navbar
      ...
      <NavbarContent
        ...
        justify="start">
        <NavbarItem >
          <Link className="flex gap-2 text-inherit" href="/admin_dashboard" >
            Home
          </Link>
        </NavbarItem>
        <NavbarItem >
          <Link aria-current="page" className="flex gap-2 text-inherit" href="/admin_dashboard/exam-management" onPress={() => setPage("attend-exam")}>
            Exams
          </Link>
        </NavbarItem>
        <NavbarItem>
          <Link className="flex gap-2 text-inherit" href="/admin_dashboard/candidate-management">
            Candidates
          </Link>
        </NavbarItem>
        <NavbarItem>
          <Link className="flex gap-2 text-inherit" href="/admin_dashboard/reviewer-management">
           Reviewers
          </Link>
        </NavbarItem>
        <NavbarItem>
          <Link className="flex gap-2 text-inherit" href="/admin_dashboard/live-monitoring">
